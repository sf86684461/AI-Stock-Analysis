// Vercel Serverless Functions Mock API (root-level)
const {
  generateHealth,
...
} = require('../frontend/src/mocks/mockData');
...
module.exports = async (req, res) => {
  ...
  // Resolve path from slug or raw URL and normalize '/api' prefix
